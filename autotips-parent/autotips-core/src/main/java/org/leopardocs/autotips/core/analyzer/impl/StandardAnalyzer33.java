...
public class StandardAnalyzer33 extends Analyzer {
	private Set stopSet;
	...
	public StandardAnalyzer33(Autotip Autotip) {
		this(Version.LUCENE_33, STOP_WORDS_SET, Autotip);
	}

	public StandardAnalyzer33(Version matchVersion, Set stopWords, Autotip Autotip) {
		this.se = Autotip;
	...
	public TokenStream tokenStream(String fieldName, Reader reader) {
		StandardTokenizer tokenStream = new StandardTokenizer(Version.LUCENE_33, reader);
	...
	public TokenStream reusableTokenStream(String fieldName, Reader reader) throws IOException {
		...
		if (streams == null) {
			...
			streams.tokenStream = new StandardTokenizer(Version.LUCENE_33, reader);
