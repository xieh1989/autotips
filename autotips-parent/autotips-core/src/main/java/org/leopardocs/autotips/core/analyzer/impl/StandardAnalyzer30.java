...
/*package org.leopard.autotips.core.analyzer.impl;
...
import org.leopard.autotips.core.config.Autotip;
import org.leopard.autotips.core.config.FieldItem;
import org.leopard.autotips.core.tools.AutoTipsTools;

public class StandardAnalyzer30 extends Analyzer {
	private Set stopSet;
	...
	*//** @deprecated *//*
	...
	public StandardAnalyzer30(Autotip Autotip) {
		this(Version.LUCENE_30, STOP_WORDS_SET, Autotip);
	}

	public StandardAnalyzer30(Version matchVersion, Set stopWords, Autotip Autotip) {
		this.se = Autotip;
	...
	private final void init(Version matchVersion) {
		setOverridesTokenStreamMethod(StandardAnalyzer30.class);
	...
	*//** @deprecated *//*
	public TokenStream reusableTokenStream(String fieldName, Reader reader) throws IOException {
		...
		if (streams == null) {
			...
			if (this.useDefaultStopPositionIncrements) {
				streams.filteredTokenStream = new StopFilter(true, streams.filteredTokenStream, this.stopSet);
			} else {
				streams.filteredTokenStream = new StopFilter(this.enableStopPositionIncrements,
