...
public class StandardAnalyzer35 extends Analyzer {
	private Set stopSet;
	...
	public StandardAnalyzer35(Autotip Autotip) {
		this(Version.LUCENE_35, STOP_WORDS_SET, Autotip);
	}

	public StandardAnalyzer35(Version matchVersion, Set stopWords, Autotip Autotip) {
		this.se = Autotip;
	...
	public TokenStream reusableTokenStream(String fieldName, Reader reader) throws IOException {
		...
		if (streams == null) {
			...
			streams.tokenStream = new StandardTokenizer(Version.LUCENE_35, reader);
