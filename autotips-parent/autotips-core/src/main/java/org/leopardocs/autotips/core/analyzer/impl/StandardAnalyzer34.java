...
public class StandardAnalyzer34 extends Analyzer {
	private Set stopSet;
	...
	public StandardAnalyzer34(Autotip Autotip) {
		this(Version.LUCENE_34, STOP_WORDS_SET, Autotip);
	}

	public StandardAnalyzer34(Version matchVersion, Set stopWords, Autotip Autotip) {
		this.se = Autotip;
	...
	public TokenStream tokenStream(String fieldName, Reader reader) {
		StandardTokenizer tokenStream = new StandardTokenizer(Version.LUCENE_34, reader);
	...
	public TokenStream reusableTokenStream(String fieldName, Reader reader) throws IOException {
		...
		if (streams == null) {
			...
			streams.tokenStream = new StandardTokenizer(Version.LUCENE_34, reader);
